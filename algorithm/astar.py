...
def a_star(start_node: Node, stop_node: Node) -> None:
    ...
    def getManhattanDistanceHeuristic(current_node: Node, end_node: Node) -> float:
    ...
    start_node.global_goal = getManhattanDistanceHeuristic(start_node, stop_node)
    ...
    while len(not_tested_nodes) != 0:
        ...
        for neighbor_node in neighbors.keys():
            ...
            possibly_lower_goal: float = current_node.local_goal + neighbors[neighbor_node]
            ...
            if possibly_lower_goal < neighbor_node.local_goal:
                ...
                neighbor_node.globaL_goal = neighbor_node.local_goal + getManhattanDistanceHeuristic(neighbor_node, stop_node)
